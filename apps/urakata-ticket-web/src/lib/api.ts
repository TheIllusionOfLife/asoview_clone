/**
 * UraKata Ticket consumer API client.
 */
...
export type TicketPassStatus = "VALID" | "USED" | "EXPIRED" | "REVOKED";
...
export async function listMyTickets(): Promise<TicketPass[]> {
  return api.get<TicketPass[]>("/v1/me/tickets");
}
